...
xrandr --output DP3 --off --output eDP1 --mode 1366x768 --pos 1920x0 --output DP1 --off --output DP2 --off --output HDMI1 --off --rotate normal --output HDMI2 --off --output HDMI1 --off --output VGA1 --mode 1920x1080 --pos 0x0  --rotate normal
